...
The immediate next product path is to implement the AcornOps Mattermost chat-login transaction contract in `docs/acornops-chat-login-contract.md` so the bot can resolve a completed browser OIDC login back to the Mattermost user.

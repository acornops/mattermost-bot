...
4. Complete the OIDC-backed Mattermost identity link after AcornOps implements the Mattermost chat-login transaction contract.
...
- `docs/acornops-chat-login-contract.md`: implementation brief for AcornOps agents building the missing contract.
